  ...
  const mailOptions = {
    ...
    <div style="font-family: Helvetica,Arial,sans-serif;min-width:1000px;overflow:auto;line-height:2">
      <div style="margin:50px auto;width:70%;padding:20px 0">
        ...
        <a style="background:#50C878; padding: 0.5rem 4rem; margin: 0 auto; text-decoration:none; color:white" href=https://seesight-next.vercel.app/users/resetPassword/${options.resetToken}>Reset password</a>
